		...
		if (isset($_POST['modificar']))
		{
			...
			else
			{
				...
				else
				{
					...
					//Validacion auxiliar para no perder los usuarios.
					$nombre = $_POST['nombre'];
					...
					//El siguiente codigo fue un agregado mio, para actualizar la sesion en caso de que actualice su propio usuario.
